...
export default function Home() {
  ...
  // 결과
  const [result, setResult] = useState(null); // { titles: [], body: "" }
...
const [features, setFeatures] = useState("");
  ...
  // 상가 - 권리금
  const [premiumStatus, setPremiumStatus] = useState("없음"); // 있음/없음/협의가능

  // 상가 - 관리비 포함항목
  const [maintenanceStatus, setMaintenanceStatus] = useState("있음"); // 있음/없음
  ...
  // 생성 핸들러
    ...
    try {
      ...
      const brokerInfo = {
        ...
        officeName: brokerData?.office_name || "",
      ...
      >
        {type}
          ...
          <div className="section-card">
            ...
            <input className="input-base" placeholder="상세주소 (동/호수)" />
          </div>
              ...
              <div className="section-card">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select className="input-base">
                      <option>남향</option><option>남동향</option><option>남서향</option>
                      <option>동향</option><option>서향</option><option>북향</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div className="section-card">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <input className="input-base" type="number" placeholder="59" />
                  </div>
                  <div>
                    <label className="label-base">공급면적 (㎡)</label>
                    <input className="input-base" type="number" placeholder="84" />
                  </div>
                  <div>
                    <label className="label-base">해당 층</label>
                    <input className="input-base" type="number" placeholder="10" />
                  </div>
                  <div>
                    <label className="label-base">총 층수</label>
                    <input className="input-base" type="number" placeholder="15" />
                  </div>
                </div>
              </div>
              ...
              <div className="section-card">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input className="input-base" type="number" placeholder="3" />
                  </div>
                  <div>
                    <label className="label-base">욕실 개수</label>
                    <input className="input-base" type="number" placeholder="2" />
                  </div>
                </div>
              </div>
              ...
              <div className="section-card">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input className="input-base" type="number" placeholder="50000" />
                  </div>
                  <div>
          ...
          {propertyKind === "상가" && (
            <>
              ...
              <div className="section-card">
                ...
                <input className="input-base" placeholder="예: 카페, 디저트, 무인매장 등" />
              </div>
              ...
              <div className="section-card">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    <label className="label-base">전용면적 (㎡)</label>
                    <input className="input-base" type="number" placeholder="33" />
                  </div>
                  <div>
                    <label className="label-base">공급면적 (㎡)</label>
                    <input className="input-base" type="number" placeholder="50" />
                  </div>
                  <div>
                    <label className="label-base">해당 층</label>
                  ...
                  <div>
                    <label className="label-base">총 층수</label>
                    <input className="input-base" type="number" placeholder="5" />
                  </div>
                </div>
              </div>
              ...
              <div className="section-card">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="label-base">보증금 (만원) *</label>
                    <input className="input-base" type="number" placeholder="3000" />
                  </div>
                  <div>
                    <label className="label-base">
                      월세 (만원) {dealType === "매매" && <span className="text-gray-400">(해당없음)</span>}
              ...
              <div className="section-card">
                ...
                {premiumStatus === "있음" && (
                  <input className="input-base" type="number" placeholder="권리금 (만원)" />
                )}
              </div>
              ...
              <div className="section-card">
                ...
                <div className="flex gap-3 items-center mb-3">
                  <input className="input-base flex-1" type="number" placeholder="관리비 (만원)" />
                  <div className="flex gap-2">
                    {["있음", "없음"].map((v) => (
                      <button
                        key={v}
                ...
                {parking === "가능" && (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <input className="input-base" type="number" placeholder="20" />
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="section-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input className="input-base" placeholder="예: 빨리빼기 공인중개사사무소" />
              </div>
              <div>
                <label className="label-base">중개사 휴대폰번호</label>
                <input className="input-base" placeholder="010-0000-0000" />
              </div>
            </div>
          </div>
